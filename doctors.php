    ...
    <div class="container">
      <div class="service-grid">
        <article class="service-card">
          <img src="/assets/images/alfiashaidar.webp" alt="Dr. Alfia Shahab Haidar" style="width:100%;height:320px;object-fit:cover;border-radius:12px;margin-bottom:12px;" loading="lazy">
        ...
        <article class="service-card">
          <img src="/assets/images/kamalrkabra.webp" alt="Dr. Kamal R Kabra" style="width:100%;height:320px;object-fit:cover;border-radius:12px;margin-bottom:12px;" loading="lazy">
        ...
        <article class="service-card">
          <img src="/assets/images/firozakhan.webp" alt="Dr. Firoz A Khan" style="width:100%;height:320px;object-fit:cover;border-radius:12px;margin-bottom:12px;" loading="lazy">
        ...
        <article class="service-card">
          <img src="/assets/images/saqibkhan.webp" alt="Dr. Saqib Khan" style="width:100%;height:320px;object-fit:cover;border-radius:12px;margin-bottom:12px;" loading="lazy">
          <h3>Dr. Saqib Khan</h3>
