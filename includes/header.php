...
<head>
  ...
  <meta property="og:image" content="<?php echo esc(page_url('assets/images/logo.png')); ?>" />
  <meta name="twitter:image" content="<?php echo esc(page_url('assets/images/logo.png')); ?>" />
        ...
        <?php foreach ($navItems as $path => $label): ?>
          <?php if ($path === 'about.php'): ?>
            <div class="nav-item has-submenu">
              <a href="<?php echo esc($path); ?>" class="nav-link-with-indicator<?php echo ($pagePath === $path || $isAboutGroupPage) ? ' active' : ''; ?>">
              ...
              <div class="submenu" role="menu" aria-label="About submenu">
                <?php foreach ($aboutSubItems as $subPath => $subLabel): ?>
                  ...
                  <a href="<?php echo esc($subPath); ?>" role="menuitem"<?php echo $pagePath === $subBasePath ? ' class="active"' : ''; ?>><?php echo esc($subLabel); ?></a>
                <?php endforeach; ?>
              </div>
            </div>
          <?php else: ?>
          ...
          <details class="mobile-submenu-wrap">
            ...
            <div class="mobile-submenu">
              <?php foreach ($aboutSubItems as $subPath => $subLabel): ?>
                ...
                <a href="<?php echo esc($subPath); ?>"<?php echo $pagePath === $mobileSubBasePath ? ' class="active"' : ''; ?>><?php echo esc($subLabel); ?></a>
              <?php endforeach; ?>
            </div>
          </details>
        <?php else: ?>
